    ...
    >
      <div className="flex items-center gap-4">
        <Button
          ...
          size="icon"
          className={cn(
            "shrink-0 size-8 rounded-full transition-all duraiton-200",
        ...
        <div className="hidden gap-2 group-hover:inline-flex animate-slide-up">
          <Button
            variant="ghost"
            size="icon"
            className="shrink-0 transition-colors size-8 to-muted-foreground hover:text-info"
            onClick={() => {
              setIsEditting(true);
              setUpdateTaskTitle(task.title || "");
            }}
          ...
          <Button
            variant="ghost"
            size="icon"
            className="shrink-0 transition-colors size-8 to-muted-foreground hover:text-destructive"
